...
export const Logo = eco.component<LogoProps, JsxRenderable>({
	...
	render: ({ children = 'scripts-injector', href, target, title }) => {
		return (
			<a href={href} target={target} title={title} class="logo">
				<svg height="28" viewBox="0 0 35 42" fill="none" xmlns="http://www.w3.org/2000/svg">
					<path
