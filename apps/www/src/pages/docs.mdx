...
<div class="rounded-md border border-primary/30 bg-primary-container px-5 py-4 my-6">
  <p class="m-0 text-sm font-bold text-on-primary-container">
    <strong>Need a no-wrapper approach?</strong>
  </p>
  <p class="m-0 mt-1 text-sm text-on-primary-container/80">
    Use the Global Script Injector with <code>data-eco-trigger</code>.
    <a href="/global" class="ml-1 font-semibold text-link no-underline hover:underline">Read the Global docs →</a>
  </p>
</div>
