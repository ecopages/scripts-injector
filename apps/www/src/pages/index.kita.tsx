      ...
      <div class="showcase">
        <section class="group flex flex-col items-center justify-center py-40 text-center max-w-7xl mx-auto">
          <h1 class="text-3xl md:text-6xl font-black tracking-tighter text-gray-900 dark:text-white mb-8 leading-[0.95] select-none">
            ...
            <br />
            <scripts-injector
              scripts="/scripts/accelerate.script.js"
              on:idle
            >
              <span
                class="text-brand-primary accelerate-word"
                data-word="Accelerate the Page"
              >
                Accelerate the Page
              </span>
            </scripts-injector>
          ...
          <p class="text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto leading-relaxed mb-12 font-medium">
            ...
            <br class="hidden md:block" /> Inject what you need, exactly when
        ...
        <div id="examples" class="space-y-32">
          ...
          <section class="showcase-section">
            <div class="showcase-info">
              ...
              <p class="section-desc">
                Delays loading of heavy logic until the user actually clicks.
                The click event is captured, the script loads, and then the
                click is replayed natively.
              </p>
            ...
            <div class="showcase-demo">
              <div class="flex items-center justify-center bg-gray-50 dark:bg-gray-900 rounded-xl p-12 min-h-75">
                <div class="text-center">
                  ...
                  <div
                    id="demo-click-log"
                    class="mt-4 text-sm font-mono text-green-600 h-6"
                  ></div>
                </div>
              </div>
            </div>
          ...
          <section class="showcase-section">
            <div class="showcase-info">
              ...
              <p class="section-desc">
                Preloads resources when a user hovers, ensuring instant
                availability without waiting for a click. Ideal for menus or
                tooltips.
              </p>
          ...
          <section class="showcase-section">
            <div class="showcase-info">
              ...
              <p class="section-desc">
                Load validation libraries, date pickers, or input masks only
                when the user focuses on a specific field.
              </p>
          ...
          <section class="showcase-section">
            <div class="showcase-info">
              ...
              <p class="section-desc">
                Non-critical resources like analytics or logging can be loaded
                when the browser is idle, preventing main-thread blocking during
                initial load.
              </p>
          ...
          <section class="showcase-section">
            <div class="showcase-info">
              ...
              <p class="section-desc">
                Inject validation or submission logic exactly when the user
          ...
          <section class="showcase-section">
            <div class="showcase-info">
              ...
              <p class="section-desc">
                Injectors can be nested within each other. Parent and child
                loading logic remains independent.
              </p>
          ...
          <section class="showcase-section">
            <div class="showcase-info">
              ...
              <p class="section-desc">
                Preload scripts <em>before</em> content enters the viewport to
                ensure zero CLS or delay when the user arrives.
              </p>
