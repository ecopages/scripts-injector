...
if (hoverArea) {
    ...
    `;
	hoverArea.className =
		'h-32 bg-white dark:bg-gray-800 border-2 border-purple-500 rounded-xl flex items-center justify-center shadow-lg shadow-purple-500/10 ring-4 ring-purple-500/5 transition-all duration-150 transform scale-100';
